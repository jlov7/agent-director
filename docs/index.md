# Agent Director Documentation Hub

This hub is organized by audience and lifecycle so readers can quickly find the right depth.

## Fast Start By Audience
...
- [`story.md`](story.md) — product narrative and positioning
- [`executive-summary.md`](executive-summary.md) — one-page summary
- [`user-journeys.md`](user-journeys.md) — end-to-end journey definitions
- [`pitch-deck.pdf`](pitch-deck.pdf) — presentation-ready deck

### 2) Set Up And Run
- [`getting-started.md`](getting-started.md) — local setup and first run
- [`hosting.md`](hosting.md) — Vercel/Pages/Codespaces/Render options
- [`api-reference.md`](api-reference.md) — endpoint-level reference

### 3) Understand The System
- [`architecture.md`](architecture.md) — topology, flow, and safety model
- [`technical-guide.md`](technical-guide.md) — practical implementation map
- [`replay-integrity.md`](replay-integrity.md) — deterministic replay controls

### 4) Operate And Support
- [`ops/support-operations.md`](ops/support-operations.md)
