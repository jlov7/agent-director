...
| P0 | CARP-P0-002 | Done | A root-level world-class gameplay TODO contradicted the current agent observability product thesis. | Archived the legacy gameplay TODO under `docs/archive/legacy-notes/` so it no longer reads as active product direction. | `docs/archive/legacy-notes/world-class-release-todo-gameplay.md`; system coherence audit. |
