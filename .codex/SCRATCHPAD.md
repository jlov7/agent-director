...
5. [ ] SWC-005 Harmonize async action resilience UX states
...
10. [ ] Continue SWC-012..SWC-027 in strict order
...
- None currently blocking the first implementation batch.
